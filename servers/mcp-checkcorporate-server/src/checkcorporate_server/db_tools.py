...
class DbTools:
    ...
    # =========================================================
    #  GET BILANCIO PER CONTO
    # =========================================================
    def get_bilancio_per_conto(
        self,
        societa: str,
        esercizio: int,
        tipo: str,
        ...
        url = f"{self.api_endpoint}/api/bilancio/get-bilancio-per-conto"
    ...
    #  GET SOCIETA
    # =========================================================
    def get_societa(self) -> List[Dict]:

        url = f"{self.api_endpoint}/api/bilancio/get-societa"
